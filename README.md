...
See [docs/](./docs/README.md) for how the app is built (architecture,
data model, routes, payments, env vars), and [SECURITY.md](./SECURITY.md)
before touching auth, payments, or RLS policies specifically -- it
explains why the entitlement/admin gating is structured the way it is,
and documents a privilege-escalation issue that was found and fixed on
2026-08-29.
